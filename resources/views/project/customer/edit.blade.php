    ...
    <form action="{{ route('customer.update', $customer->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            ...
            <input type="text" class="
                ...
                m-0
                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
              " name="customer" value="{{ old('customer' ,$customer->customer) }}" required>
        ...
        <div class="mb-5">
            ...
            <input type="text" class="
                ...
                m-0
                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
              " name="attention" value="{{ old('attention' ,$customer->attention) }}">
        ...
        <div class="mb-5">
            ...
            <input type="file" class="
                ...
                m-0
                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
              " name="logo" value="{{ old('logo' ,$customer->logo) }}">
        ...
        <div class="mb-5">
            ...
            <textarea
                ...
                class="
                  ...
                  "
                cols="30" rows="10"
                >{{ old('location' ,$customer->location) }}</textarea>
